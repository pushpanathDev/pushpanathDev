...
class Pushpanath:
    def __init__(self):
        self.name        = "Pushpanath M R"
        self.role        = "AI/Full-Stack Engineer"
        self.education   = "MTech Integrated Software Engineering @ VIT Chennai"
        self.current     = "5G L1/PHY Intern @ Nokia Solutions & Networks, Bengaluru"
        self.patent      = "AI Smart Backpack · PS00020319 (2024)"
        self.interests   = ["LLMs", "RAG Systems", "5G PHY Layer", "System Design"]
        self.looking_for = "Full-time SWE / AI Engineer roles (2026)"

    def say_hi(self):
        print("Building tech that actually matters. Let's ship something cool.")
```
...
> 🔬 **AI Smart Backpack** · Patent No. PS00020319 · *Published 2024*  
> An intelligent backpack system leveraging AI for weight monitoring, posture tracking, and smart alerts.

---

## 🤝 Let's Connect

I'm actively looking for **full-time Software / AI Engineering roles** starting mid-2026.  
If you're hiring or want to collaborate on something cool — reach out!

<div align="center">

[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:pushpanathmr@gmail.com)
...
[![Portfolio](https://img.shields.io/badge/Portfolio-000000?style=for-the-badge&logo=vercel&logoColor=white)](https://pushpanath.dev)
...
<div align="center">
  <img src="https://komarev.com/ghpvc/?username=pushpanathDev&color=00d9ff&style=flat-square&label=Profile+Views" />
</div>
